...
class LoginScreen(MDScreen):
    ...
    def validate_login(self, email, password):
        ...
        if not aux.is_correct_password(password, db.get_password_by_user_id(self.db_connection, user_id)):
    ...
    def login(self):
        ...
        if res == 'OK':
            ...
            root.user = User(id=user_id, **user_info, db_connection=self.db_connection)
